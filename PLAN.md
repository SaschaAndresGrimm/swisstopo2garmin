...
| **Raster / paper-map view** | **not started** | Deferred past v1 by decision. Garmin KMZ custom maps or a JNX-style raster overlay from `ch.swisstopo.pixelkarte-farbe`. |
