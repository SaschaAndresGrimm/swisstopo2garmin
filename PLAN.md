...
| **Address search** | **not started** | swissTLM3D carries `tlm_strassen_strassenname` (173,860 rows), so street names exist; what is missing is emitting `addr:` tags and building the MDR index mkgmap needs for address lookup. |
